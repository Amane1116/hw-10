...
const char* ssid = "Amane";  // insert your SSID
const char* password = "sophia030";  // insert your password
...
const char* resource = "/data/2.5/weather?id=1668341&appid=241e5c2783ba2ab7431f2b6d59d2fbc2"; 
...
void SendLineNotyfy(String value1, String value2, String value3){
  ...
  WiFiClient client;  //建立Client物件
  const int httpPort = 80;  //預設通訊阜80
  //String url = "https://maker.ifttt.com/trigger/line_notify/with/key/dPyYp3N4BelhDWI-qwBE-q";  //API url
  String JsonString = "";  //此範例不會用到
